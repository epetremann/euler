defmodule Euler.Problem61 do
  ...
  def get_suites(l1, l2, l3, l4, l5, l6) do
    for px1 <- l1,
        ...
        px6 <-
          l6
          |> Enum.filter(fn x -> rem(px5, 100) == div(x, 100) && rem(x, 100) == div(px1, 100) end) do
  ...
  def do_get_pnlist(n1, n2, func_pn, i, pnlist) do
    ...
    cond do
      ...
      pni < n1 ->
        do_get_pnlist(n1, n2, func_pn, i + 1, pnlist)

      pni >= n1 and
          pni <= n2 ->
        do_get_pnlist(n1, n2, func_pn, i + 1, [pni | pnlist])
    end
  end
end
