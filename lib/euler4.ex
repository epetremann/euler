defmodule Euler4 do
  ...
  def find_factor_of(_big_number, current_number, _start, finish, _step) when current_number < finish do
    {nil, nil}
  end
  ...
  def biggest_palindrom_of_two_numbers_of_size(current_n1, _start, finish) when current_n1 < finish do
    nil
  end
